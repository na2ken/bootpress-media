...
<section class="gryColor">
    <div class="container">
        <div class="row ">

<div class="col-sm-4 verticalMargin-t-sm verticalMargin-b-xs">
<h2 class="h3 NotoSansJP-Thin">コンテンツA</h2>
<?php
     global $post;
     $my_posts= get_posts(array(
...
?>
  ...
  <?php endif; ?>
<div class="col-xs-12 verticalMargin-b-xs wht">
...
<div class="col-sm-4 verticalMargin-t-sm verticalMargin-b-xs">
<h2 class="h3 NotoSansJP-Thin">コンテンツB</h2>
<?php
     global $post;
     $my_posts= get_posts(array(
...
<div class="col-sm-4 verticalMargin-t-sm verticalMargin-b-xs">
<h2 class="h3 NotoSansJP-Thin">Ad.</h2>

<figure class="verticalMargin-b-xs">
    <a href="#">
