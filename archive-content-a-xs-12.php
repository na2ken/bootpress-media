...
/* v1.0 */
get_header(); ?>
<!-- ◆ archive-panel-3col template(bootstrap) ◆ -->
<div class="l-cover">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
...
<article class="gryColor">
            ...
            <div class="container">
                <div class="row">
                  ...
                  the_post(); ?>
                  <div class="col-sm-6 col-md-4 verticalMargin-t-sm verticalMargin-b-sm wow fadeInUp" data-wow-duration="2.5s" data-wow-delay="0s">
                      <div class="col-xs-12">
                      <div class="row">
                          <section>
                  <div class="">
